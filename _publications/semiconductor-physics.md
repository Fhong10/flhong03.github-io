...
<div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: flex-start;">
    ...
    <div style="width: 220px; text-align: center;">
     ...
     <div style="width: 220px; text-align: center;">
        <p style="margin-bottom: 5px; font-weight: bold;">Graphene Contact for modulation of doping</p>
...
### Note: This is Fig. 1d from Qi et al. (2023), shown for illustration. It is not a result from my device and device stack differs. I brought the figure for explanation.
